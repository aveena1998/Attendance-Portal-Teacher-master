...
import com.example.auotmaticattendance.MessageActivity;
...
//        getstudentid();
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if(item.getItemId()==R.id.createmsg)
        {
        ...
        public void onDataChange(@NonNull DataSnapshot snapshot) {
            if(snapshot.exists())
            {
                ...
                if(Branch.equals(branch) && Year.equals(year)){
                    incr++;
                    viewstudentobject obk=new viewstudentobject(profilepic,name,rollno,email,phone);
